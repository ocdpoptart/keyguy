function standoff_extrude_8_outline_fn(){
...
function board_extrude_12_outline_fn(){
...
.extrude({ offset: [0, 0, 12] });
                ...
                let standoffs__part_0 = standoff_extrude_8_outline_fn();
                ...
                let innerWall__part_0 = board_extrude_12_outline_fn();
